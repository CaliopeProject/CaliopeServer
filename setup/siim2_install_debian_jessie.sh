...
sudo apt-get install -y git aptitude redis-server software-properties-common python-software-properties make python-dev python-pip libevent-dev virtualenvwrapper python-virtualenv redis-server libjpeg-dev zlib1g-dev libpng-dev tesseract-ocr libtesseract3 tesseract-ocr-eng tesseract-ocr-spa  python-software-properties python g++ imagemagick nodejs npm
